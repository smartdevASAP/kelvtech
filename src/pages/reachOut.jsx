  ...
  return (
    <div class="max-w-5xl w-full mx-auto p-10 text-gray-800">
      ...
      <p class="text-left mt-4">
        ...
        >
          kelvinnjuguna357@gmail.com
        </a>
      </p>
      <div class="grid md:grid-cols-3 space-y-4 mt-16">
        <div className="bg-indigo-50 p-4 mr-5 rounded-sm">
          <svg
            class="text-indigo-500 bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <div className="bg-indigo-50 p-4 mr-5 rounded-sm">
          ...
          <span class="text-indigo-600 font-semibold">Nairobi, Kenya</span>
        </div>
        <div className="bg-indigo-50 p-4 mr-5 rounded-sm">
          <svg
            class="text-indigo-500 bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10"
          ...
          <span class="text-indigo-600 font-semibold">+254799065377</span>
        </div>
      </div>
    </div>
  );
